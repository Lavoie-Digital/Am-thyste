...
const CONTENT: Record<"fr" | "en", FormationContent> = {
  fr: {
    ...
    webinarBadge: "Nouveau",
    webinarTitle: "Des webinaires hebdomadaires",
    webinarDesc:
      "Des webinaires hebdomadaires permettront aux coiffeurs et coiffeuses déjà expérimentés dans le rituel de se perfectionner et d'élever leurs services.",
  ...
  en: {
    ...
    webinarDesc:
      "Weekly webinars help stylists already experienced with the ritual refine their craft and elevate their services.",
    ctaTitle: "Sign up",
